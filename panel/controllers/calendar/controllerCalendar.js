...
exports.createQrCode = async (req,res) => {
    ...
    qr_svg.pipe(require('fs').createWriteStream('/root/home/jcv/app/public/panel/qrcode-rooms/room-'+idRoom+'.png'));

    var svg_string = qr.imageSync('I love QR!', { type: 'png' });

    //let fileDow = 'public/panel/qrcode-rooms/room-'+idRoom+'.png';
    let fileDow = '/root/home/jcv/app/public/panel/qrcode-rooms/room-'+idRoom+'.png';
